...
--            ※ 이후 황준상 취소가 반영돼 최종 8/18 20명 · 8/19 20명 · 총 40명 (맨 아래 참고)
--
...
-- ── 황준상 취소 (2026-08-18 처리 완료) ──────────────────────────────────
-- event-mango-0818-move.sql 의 "황준상(백석문화대) 참가 취소"도 8/17 에 실행되지 않았으나
-- 2026-08-18 SQL Editor 에서 실행 완료했다.
--   delete from public.event_signups where event_key='mango' and id='9be1bef63045a7c3';
--
-- ── 최종 (2026-08-18 확인) ──────────────────────────────────────────────
-- 8/18(화) 20명 · 8/19(수) 20명 · 총 40명
