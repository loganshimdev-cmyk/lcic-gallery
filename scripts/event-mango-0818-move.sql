...
-- ⚠️ 이 파일은 작성 당시(8/17) 실행되지 않았다. 2026-08-18 조회 시 3명 모두 8/18 에 그대로 있었고
--    황준상도 남아 있었다. 둘 다 2026-08-18 에 뒤늦게 반영 완료 —
--    날짜 변경 3명은 event-mango-0818-move2.sql, 황준상 취소는 이 파일을 SQL Editor 에서 실행.
